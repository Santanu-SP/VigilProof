...
import SectionForensicBackdrop from '../home/SectionForensicBackdrop';

export default function Footer() {
  return (
    <footer className="site-footer border-t border-white/5 mt-auto py-12 relative z-10 overflow-hidden">
