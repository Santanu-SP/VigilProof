        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          ...
          >
            ...
            <div className="flex gap-6 items-start p-6 bg-white border border-slate-200 rounded-xl shadow-sm hover:shadow-md transition-shadow">
              ...
              <div>
                <h4 className="text-lg font-bold text-slate-900 mb-1">Sandboxed inspection</h4>
                <p className="text-sm font-mono text-slate-600">Suspicious pages are treated as untrusted and isolated.</p>
              </div>
            </div>
          </motion.div>
        </div>
